...
/* tslint:disable */ 
  ...
  'CREATE TABLE IF NOT EXISTS SECRET_ITEM_FIELD (SECRET_ITEM_FIELD_ID TEXT PRIMARY KEY UNIQUE, SECRET_ITEM_ID TEXT NOT NULL, FIELDNAME TEXT NOT NULL, FIELDTYPE TEXT NOT NULL, FOREIGN KEY (SECRET_ITEM_ID) REFERENCES SECRET_ITEM (SECRET_ITEM_ID) ON DELETE CASCADE ON UPDATE NO ACTION)',
