...
-- 005: SECRET ITEMS
CREATE TABLE [IF NOT EXISTS] SECRET_ITEM (SECRET_ITEM_ID INTEGER PRIMARY KEY UNIQUE, SECRET_TYPE_ID INTEGER NOT NULL, SECRET_TYPE_NAME TEXT NOT NULL UNIQUE, NAME TEXT NOT NULL, DATECREATED TEXT NOT NULL, DATELASTMODIFIED TEXT NOT NULL, MAGICTEXT INTEGER NOT NULL, AWESOMETEXT INTEGER NOT NULL);
